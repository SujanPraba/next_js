...
const Card = () => {
  ...
  const boxStyles = {
    ...
    box: "flex-none md:w-[580px] w-[390px] md:h-[280px] h-[220px] mr-8 py-2 rounded-[12px] delay-500 snap-align-start text-left bg-white shadow-[1px_3px_8px_3px_rgba(0,0,0,0.10)]",
  };
