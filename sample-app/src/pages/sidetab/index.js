      ...
      <div className="lg:flex block  w-[90%]">
        <div className="w-full lg:w-[30%]  lg:border-y-2 lg:border-r-none lg:border-l-[#D45147]  lg:border-y-[#D45147] lg:border-l-2 rounded-l-[36px]  lg:text-[30px] text-[10px] sm:text-[20px] font-semibold text-[#031555] hidden lg:block">
          <div className="flex lg:flex-col lg:justify-normal rounded-l-[36px] justify-around">
            <button
              className={`lg:px-[8px] lg:py-[12px] px-[9px] py-[2px] sm:py-[4px] sm:px-[8px] md:py-[6px] md:px-[10px] rounded-tl-[33px] bg-[#D45147] transition-all duration-200 ${
                activeTab === 2
                  ? "rounded-br-[36px]"
                  : activeTab === 1
            ...
            <button
              className={`lg:px-[8px] lg:py-[12px] px-[9px] py-[2px] sm:py-[4px] sm:px-[8px] md:py-[6px] md:px-[10px] bg-[#D45147] transition-all duration-200 ${
                activeTab === 3
                  ? "rounded-br-[36px]"
                  : activeTab === 1
                  ? " rounded-tr-[36px]"
            ...
            <button
              className={`lg:px-[8px] lg:py-[12px] px-[9px] py-[2px] sm:py-[4px] sm:px-[8px] md:py-[6px] md:px-[10px] rounded-bl-[33px] transition-all duration-200  bg-[#D45147]  ${
                activeTab === 4
                  ? "rounded-tr-[36px]"
                  : activeTab === 5
        ...
        <div className="w-full   lg:bg-[#D45147] lg:border-y-2 lg:border-r-none lg:border-l-[#D45147]  lg:border-y-[#D45147] lg:border-l-2  lg:rounded-l-[36px]  lg:text-[30px] text-[12px] sm:text-[20px] font-semibold text-[#031555] lg:hidden">
          <div className="block">
            <div className="flex justify-around ">
              <button
                className={`lg:px-[8px] lg:py-[12px] px-[20px] py-[12px]  border-[2px] border-[#031555] lg:border-none rounded-[30px] lg:rounded-tl-[36px] lg:rounded-none ${
                  activeTab === 1
              ...
              <button
                className={`lg:px-[8px] lg:py-[12px] px-[20px] py-[12px] border-[2px] border-[#031555] lg:border-none rounded-[30px] lg:rounded-none ${
                  activeTab === 2
                    ? "lg:bg-[white] bg-[#031555] text-textWhite lg:text-[#031555]"
                    : "lg:bg-[#D45147]"
                }`}
            ...
            <div className="flex justify-evenly mt-6">
              ...
              <button
                className={`lg:px-[8px] lg:py-[12px] px-[20px] py-[12px] border-[2px] border-[#031555] lg:border-none rounded-[30px] lg:rounded-bl-[36px] lg:rounded-none ${
                  activeTab === 5
                    ? "lg:bg-[white] bg-[#031555] text-textWhite lg:text-[#031555]"
                    : "lg:bg-[#D45147]"
                }`}
        ...
        <div className="w-full lg:w-3/4 p-4 bg-white lg:mt-0 mt-3 border-0 lg:border-0 border-[#D45147] rounded-[36px] lg:border-y-2 lg:border-r-2  lg:border-r-[#D45147] lg:border-y-[#D45147] lg:border-l-none lg:rounded-r-[36px] lg:rounded-none">
          ...
          {activeTab === 4 && (
            <div className=" lg:p-[8px] xl:px-[10px]">
              <Image src={telcom} alt="telcom" className="hidden lg:block" />
