...
const OurTechStack = () => {
  ...
  return (
    <div className="hidden lg:block">
      <div className="flex w-[70%] mx-auto justify-around px-[20px] py-[10px]">
        <div>
          <button
            className={`button ${
          ...
          >
            <span onClick={toggleVisibility}>DevOps Service</span>
          </button>
        ...
        <div>
          ...
          >
            <span onClick={toggleVisibility1}>Application Service</span>
          </button>
