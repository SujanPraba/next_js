  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-around  px-[28px] text-textDarkBlue  ">
        ...
        <div className="w-full  h-[3px] bg-bgPrimaryRed" />
    ...
    <header>
      ...
      <div className="w-full h-[100%] lg:h-11 lg:py-12 lg:w-screen  lg:bg-textWhite z-50  lg:fixed lg:top-0 lg:left-0 lg:right-0   text-black lg:text-white bg-white lg:bg-transparent">
        <div className="max-w-screen-2x h-full  px-7 flex items-center justify-between">
          ...
          <div className="w-[700px] text-[16px] p-3  justify-between   hidden lg:flex">
            <ul className="w-[75%] flex justify-between  items-center text-poppins  ">
              <li
